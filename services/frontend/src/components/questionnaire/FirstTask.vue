       ...
       <!-- SUBTASK 1: GRID ONLY -->
        <div v-if="subStep === 1">
            ...
            <div class="map-grid-wrapper">
                <!-- MAP IMAGE -->
                <img
                    src='task_images/uncertainty_fuzzy.png'
                    class="map-image"
                />
        ...
        <div v-if="subStep === 2">
            ...
            <div class="map-grid-wrapper">
                <!-- MAP IMAGE -->
                <img
                    src='task_images/uncertainty_ink.png'
                    class="map-image"
                />
        ...
        <div v-if="subStep === 3">
            ...
            <div class="map-grid-wrapper">
                <!-- MAP IMAGE -->
                <img
                    src='task_images/uncertainty_pattern_width.png'
                    class="map-image"
                />
        ...
        <div v-if="subStep === 4">
            ...
            <div class="map-grid-wrapper">
                <!-- MAP IMAGE -->
                <img
                    src='task_images/uncertainty_pattern_orientation.png'
                    class="map-image"
                />
        ...
        <div v-if="subStep === 5">
            ...
            <div class="map-grid-wrapper">
                <!-- MAP IMAGE -->
                <img
                    src='task_images/uncertainty_noise_width.png'
                    class="map-image"
                />
        ...
        <div v-if="subStep === 6">
            ...
            <div class="map-grid-wrapper">
                <!-- MAP IMAGE -->
                <img
                    src='task_images/uncertainty_noise_frequency.png'
                    class="map-image"
                />

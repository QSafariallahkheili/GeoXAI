...
export function addCustomPatternLayerToMap (geojson, prop1, prop2, prop3, classes, classes1, visVar1, visVar2, map){
    let radiusVariable
    let colorVariable
    let classForRadius
    let classesForColor
...
export function addCustomBorderLayerToMap (geojson, prop1, prop2, prop3, classes, classes1, visVar1, visVar2, map){
  let radiusVariable
  let colorVariable
  let classForRadius
  let classesForColor
...
export function addCustomBorderLayerWithNoisegrainToMap (geojson, prop1, prop2, prop3, classes, classes1, visVar1, visVar2, map){
  let radiusVariable
  let colorVariable
  let classForRadius
  let classesForColor
